...
- **Функционалност**: 
  ...
  - Включване в изтегления JSON файл
...
5. Изтеглете генерирания JSON файл с данните
6. Файлът също се съхранява в localStorage на браузъра
...
5. **Submission**:
   ...
   - Създаване на downloadable JSON blob
