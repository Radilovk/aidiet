...
8. **admin_emoeat_prompt.txt** - AI анализ на емоционалното хранене
   - Входни данни: 10 отговора от въпросник с фиксирани варианти за избор (+ незадължително собствено допълнение) за емоционално хранене
   - Изходни данни: Дълбок индивидуализиран психологически профил с архетипи, кръстосани модели, лични прозрения, терапевтични стратегии, HALT профил и спешен протокол
...
Отговори от въпросника: `{answer1}` до `{answer10}` (избран отговор от фиксирани варианти + незадължително собствено допълнение, 10 въпроса за емоционално хранене)
