...
8. **admin_emoeat_prompt.txt** - AI анализ на емоционалното хранене
   - Входни данни: 10 избрани образа/усещания от ПРОЕКТИВЕН въпросник (клиентът не отговаря директно с клинично самоописание, а избира спонтанно образ; + незадължително собствено допълнение)
   - Изходни данни: Дълбок индивидуализиран психологически профил с декодирани образи, архетипи, кръстосани модели, лични прозрения, терапевтични стратегии, HALT профил и спешен протокол
...
Отговори от въпросника: `{answer1}` до `{answer10}` (избран проективен образ/усещане от фиксирани варианти + незадължително собствено допълнение, 10 сценарии за емоционално хранене)
