...
Шаблон ястие: [PRO (1x)] + [ENG (0-1x)] + [VOL (1-2x)] + [FAT (0-1x)]
- PRO: яйца, пилешко, риба, говеждо, кисело мляко, извара, сирене, боб, леща
- ENG: овес, ориз, картофи, паста, булгур
- VOL: домати, краставици, чушки, салата, спанак, броколи
- FAT: зехтин, масло, ядки
