...
НАСОКИ ЗА ДОБАВКИ (РЕФЕРЕНТНИ ДИАПАЗОНИ - адаптирай според индивидуалния здравен статус):
- При висок стрес: Магнезий (300-400mg), Ашвагандха (внимание при тиреоидни медикаменти), Витамин B комплекс
- При лош сън: Магнезий, Мелатонин (0.5-3mg, внимание при кръвно налягане медикаменти), L-Теанин
...
- При диабет: Хром (внимание при диабетни медикаменти - може да засили ефекта), Магнезий, Алфа липоева киселина
- При анемия: Желязо + Витамин C (за усвояване)

ПРОТИВОПОКАЗАНИЯ (задължително провери):
...
- Ашвагандха: Противопоказана при тиреоидни медикаменти (левотироксин и др.)
- Мелатонин: Внимание при медикаменти за кръвно налягане, диабет, имуносупресори
- Хром: Може да засили ефекта на инсулин и други диабетни медикаменти
- Цинк: Намалена доза при медикаменти за кръвно налягане и диуретици

ВАЖНО: Горните диапазони са референтни. АДАПТИРАЙ дозировката според:
- Тежест на симптомите/проблема
- Други медикаменти и възможни взаимодействия
- Възраст, пол, телесно тегло
