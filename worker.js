...
function generateMockResponse(prompt) {
  if (prompt.includes('7-дневен хранителен план')) {
    return JSON.stringify({
      ...
      psychology: [
        "Не се обвинявайте ако 'съгрешите' с едно хранене - просто продължете по план следващия път",
        "Слушайте тялото си - хранете се когато сте гладни, а не емоционални или отегчени",
        "Едно хранене не разваля прогреса - фокусирайте се върху дългосрочните резултати"
      ],
