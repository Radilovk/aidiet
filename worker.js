...
3в. goalAdjustmentPercent — корекция спрямо цел (индивидуализирана)
  Базирай на: goal, lossKg, bmi (от анализа), dietHistory, metabolicReactivity (Стъпки 1–2), психологическа устойчивост (Стъпка 2), additionalNotes (ако засяга целта)
  Насоки за Отслабване (диапазон -10% до -20%):
    - висок BMI (>30) + голям lossKg → по-голям дефицит (-17% до -20%)
    - нормален/леко наднормен BMI + малък lossKg → умерен дефицит (-10% до -15%)
    - лош диетичен опит / психологически риск / бавен метаболизъм → намали дефицита с 2–5%
  Насоки за Поддръжка: 0%
  Насоки за Покачване на мускулна маса: +5% до +15% (по-малко при по-висок BMI, повече при нисък BMI + активен тренинг)
  Диапазон: -20% до +15%
...
- цел и lossKg: Отслабване → протеин ≥30% (опазване на мускулна маса при дефицит); Покачване на мускулна маса → протеин ≥30% + повишени въглехидрати; Поддръжка → балансирано
