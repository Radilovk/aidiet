...
3. СПЕЦИАЛНИ СЛУЧАИ:
   ...
   b) СВОБОДНО ХРАНЕНЕ/ЛЮБИМА ХРАНА:
      ...
      - В weeklyScheme.sunday.description ЗАДЪЛЖИТЕЛНО опиши свободното хранене (напр. "Свободно хранене за обяд - яж каквото желаеш умерено, последвано от лека вечеря")
   ...
   c) ФАСТИНГ И ЦИКЛИЧНИ СХЕМИ:
      ...
      - ВАЖНО: Ден с под 3 хранения (напр. само Обяд + Вечеря) е изключение и трябва да е ФАСТИНГ схема (16:8 IF) - задължително обозначи в weeklyMealPattern и description за деня
