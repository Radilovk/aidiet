...
б) План с по-малко от 3 хранения дневно да се избягва. Той е допустим само и единствено, ако има реална причина за това.
   ...
   b) СВОБОДНО ХРАНЕНЕ/ЛЮБИМА ХРАНА:
      - Прецени клинично — спрямо честотата на преяждане, емоционални тригери, история с рестриктивни диети, здравни условия и самоконтрол
   ...
   c) ДЕСЕРТ: Реши дали includeDessert е клинично оправдан — спрямо желанията за сладко, здравословното, хранителните тригери и целта. Обоснови в planJustification.
   
   d) ФАСТИНГ И ЦИКЛИЧНИ СХЕМИ:
...
- includeDessert: клинична преценка (true/false) — не е автоматично; обоснови в planJustification
