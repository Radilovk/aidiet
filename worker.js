...
- ВСЕКИ ден трябва да има минимум 3 хранения (закуска, обяд, вечеря)
- НИКОГА не пропускай дни или хранения
- Разпредели калориите балансирано между храненията (закуска ~25%, обяд ~40%, вечеря ~35%)`;
}
