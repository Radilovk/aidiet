...
ВАЖНО: Психологическите съвети (psychology) и препоръките за хранителни добавки (supplements) ТРЯБВА да бъдат масиви с ТОЧНО 3 елемента. Всеки елемент трябва да започва с "! " (удивителна и интервал), за да се форматира правилно като bullet point във фронтенда.
...
3. Всеки елемент в тези масиви ТРЯБВА да започва с "! " (удивителна и интервал)
