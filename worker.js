...
4. ПОЗВОЛЕНИ ТИПОВЕ ХРАНЕНИЯ:
   - "Закуска" - САМО като първо хранене на деня
   - "Обяд" - САМО след закуската или като първо хранене (ако няма закуска)
   - "Следобедна закуска" - САМО между обяд и вечеря (опционално)
   - "Вечеря" - ВИНАГИ като последно хранене на деня
5. КАЛОРИЙНА АДЕКВАТНОСТ: Ако калориите не достигат целта, увеличи порциите на съществуващите хранения, НЕ добавяй хранения след вечеря!

ВАЖНО: Калориите ТРЯБВА да достигнат целта чрез подходящо разпределение в позволените хранения!
...
=== МЕДИЦИНСКИ И ДИÉTÉTИЧНИ ПРИНЦИПИ ЗА РЕД НА ХРАНЕНИЯ ===
КРИТИЧНО ВАЖНО: Следвай СТРОГО медицинските и диететични принципи за ред на храненията:
1. ХРОНОЛОГИЧЕН РЕД: Храненията ТРЯБВА да следват естествения дневен ритъм
   - Закуска (сутрин) - ВИНАГИ първо ако има закуска
   - Обяд (обед) - след закуската или първо хранене ако няма закуска
...
Създай пълни 7 дни (day1 до day7) с по 3-4 хранения на ден В ПРАВИЛЕН ХРОНОЛОГИЧЕН РЕД. Всяко хранене трябва да е УНИКАЛНО, балансирано и строго съобразено с индивидуалните нужди, предпочитания и здравословно състояние на клиента.`;
  }
