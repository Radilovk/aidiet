...
async function handleAnalyzeKidsFoodImage(request, env) {
  try {
    ...
    // Age-conditional required risks: choking hazard is only relevant for young children
    const requiredRisks = (ageLabel === '0-1' || ageLabel === '1-3' || ageLabel === '3-7')
      ? 'Задавяне, Алергени, Захар, Добавки, Сол, Кофеин'
      : ageLabel === '7-12'
      ? 'Алергени, Захар, Добавки, Сол, Кофеин, Хранителна стойност'
      : 'Алергени, Захар, Добавки, Кофеин, Хранителна стойност, Преработка';
...
- Рисковете (risks) трябва да покриват: ${requiredRisks} като минимум
