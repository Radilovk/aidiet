...
ВАЖНО: Вземи предвид тези здравословни състояния при анализа! Ако детето има алергия, тази храна трябва да получи НИСКА оценка ако съдържа алергена. Ако детето има диабет — захарта е особено опасна. Ако има наднормено тегло — калориите и мазнините са критични. Съобрази всички рискове и оценката с описаните здравословни проблеми.`;
    }
    ...
    const chokingCriteria = isAge3Plus
      ? ''
