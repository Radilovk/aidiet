...
Върни JSON със стратегия (БЕЗ универсални препоръки):
{
  ...
  "weeklyMealPattern": "ХОЛИСТИЧНА седмична схема на хранене (напр. '16:8 интермитант фастинг ежедневно', '5:2 подход', 'циклично фастинг', 'свободен уикенд', или традиционна схема с варииращи хранения)",
  "mealTiming": {
...
- Интермитант фастинг (16:8, 18:6, OMAD) е напълно валиден избор ако подхожда
...
- Подкрепяй ИНТЕРМИТАНТ ФАСТИНГ ако е подходящ за целта (напр. 16:8, 18:6, или дни с по-малко хранения)
...
- Интермитант фастинг 16:8: 2 хранения/ден (обяд + вечеря) през седмицата
