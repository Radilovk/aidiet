...
Върни JSON със стратегия (БЕЗ универсални препоръки):
{
  ...
  "supplementRecommendations": [
    "! ІНДИВИДУАЛНА добавка 1 за {name} - конкретна добавка с дозировка и обосновка защо Е НУЖНА за този клиент (БАЗИРАНА на: възраст {age} год., пол {gender}, цел {goal}, медицински състояния {medicalConditions})",
