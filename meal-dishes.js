...
export const MEAL_DISHES = [
  ...
  dish('meal_hearty_pasta_chicken', 'Паста с пиле и домати', [['паста', 200], ['пилешко месо', 160], ['Домати', 100]],
    ['main'], { universality: 5, tags: ['high_energy'] }),
  dish('meal_hearty_beef_rice', 'Говеждо с ориз (обилна порция)', [['говеждо', 160], ['ориз', 240], ['Зеленчуци', 100]],
    ['main'], { universality: 5, tags: ['high_energy'] }),
  dish('meal_hearty_salmon_rice', 'Сьомга с ориз и спанак', [['сьомга', 150], ['ориз', 220], ['спанак', 100]],
    ['main'], { universality: 4, tags: ['high_energy'] }),
  dish('meal_hearty_turkey_potato', 'Пуешко с картофи (обилна порция)', [['пуешко филе', 170], ['картофи', 260], ['зелен фасул', 100]],
    ['main'], { universality: 4, tags: ['high_energy'] }),
  dish('meal_hearty_chicken_bulgur', 'Пиле с булгур и чушки', [['пилешко месо', 170], ['булгур', 220], ['Чушки', 100]],
    ['main'], { universality: 4, tags: ['high_energy'] }),
  dish('meal_hearty_cod_potato', 'Треска с картофи и зеленчуци', [['треска', 160], ['картофи', 250], ['Зеленчуци', 100]],
    ['main'], { universality: 4, tags: ['high_energy'] }),
  dish('meal_hearty_lentil_chicken', 'Пиле с леща и моркови', [['пилешко месо', 140], ['леща', 200], ['Моркови', 80]],
    ['main'], { universality: 4, tags: ['high_energy'] }),
  dish('meal_hearty_beef_pasta', 'Паста с говеждо и домати', [['паста', 220], ['говеждо', 160], ['Домати', 100]],
    ['main'], { universality: 5, tags: ['high_energy'] }),
  ...
  dish('meal_sweet_potato_lentil', 'Сладки картофи с леща', [['сладки картофи', 200], ['леща', 150], ['Моркови', 80]],
    ['main'], { vegan: true, universality: 4 }),
  dish('meal_hearty_lentil_rice', 'Леща с ориз и моркови', [['леща', 200], ['ориз', 180], ['Моркови', 80]],
    ['main'], { vegan: true, universality: 5, tags: ['high_energy'] }),
  ...
  dish('meal_tofu_sweet_potato', 'Тофу със сладки картофи', [['тофу', 150], ['сладки картофи', 180], ['броколи', 80]],
    ['main'], { vegan: true, universality: 3 }),
  dish('meal_hearty_bean_potato', 'Боб с картофи и моркови', [['боб', 200], ['картофи', 200], ['Моркови', 80]],
    ['main'], { vegan: true, universality: 4, tags: ['high_energy'] }),
