 ...
 *
 * Договор: всяко хранение е готово ястие от тук. Алгоритъмът не сглобява
 * продукти — избира ястие и мащабира порцията в нормални граници (×0.65–×1.45
 * около рецептата) според калориите и макросите на слота.
 *
 * РЕДАКТИРАЙ: data/meal-dishes.json (директно в repo)
 * Админ KV overlay: admin-food-catalog.js
 */
