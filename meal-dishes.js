...
export const MEAL_DISHES = [
  ...
  dish('meal_omelet_veg', 'Омлет със спанак и домати', [['яйца', 150], ['спанак', 60], ['Домати', 60], ['зехтин', 8]],
  ...
  dish('meal_rice_chicken', 'Пиле с ориз и зеленчуци', [['пилешко месо', 130], ['ориз', 150], ['Зеленчуци', 100], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_chicken_rice_broccoli', 'Пилешки гърди с ориз и броколи', [['пилешки гърди', 130], ['ориз', 150], ['броколи', 100], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_grilled_chicken', 'Пиле на скара със зеленчуци', [['пилешко месо', 150], ['Зеленчуци', 150], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_chicken_potato', 'Пиле с картофи', [['пилешко месо', 130], ['картофи', 200], ['зелен фасул', 80], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_pasta_chicken', 'Паста с пиле и домати', [['паста', 150], ['пилешко месо', 120], ['Домати', 80], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  ...
  dish('meal_chicken_soup', 'Пилешка супа', [['пилешко месо', 100], ['Зеленчуци', 150], ['ориз', 50], ['зехтин', 8]],
    ['main'], { universality: 5 }),
  dish('meal_chicken_bulgur', 'Пиле с булгур и зеленчуци', [['пилешко месо', 130], ['булгур', 150], ['Чушки', 80], ['зехтин', 10]],
    ['main'], { universality: 3 }),
  dish('meal_chicken_spinach', 'Пиле със спанак и картофи', [['пилешко месо', 130], ['спанак', 100], ['картофи', 150], ['зехтин', 10]],
    ['main']),
  dish('meal_turkey_rice', 'Пуешко с ориз', [['пуешко филе', 130], ['ориз', 150], ['Тиквички', 80], ['зехтин', 10]],
    ['main']),
  dish('meal_turkey_potato', 'Пуешко с картофи', [['пуешко филе', 130], ['картофи', 200], ['зелен фасул', 80], ['зехтин', 10]],
    ['main']),

  // ── Червено месо ─────────────────────────────────────────────────────
  dish('meal_beef_potato', 'Говеждо с картофи', [['говеждо', 130], ['картофи', 200], ['Моркови', 60], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  ...
  dish('meal_beef_mushrooms', 'Говеждо с гъби', [['говеждо', 130], ['гъби', 120], ['зехтин', 10]],
    ['main']),
  dish('meal_pork_potato', 'Свинско с картофи', [['свинско', 130], ['картофи', 200], ['зеле', 100], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_pork_beans', 'Свинско с боб', [['свинско', 100], ['бял боб', 200], ['лук', 30], ['зехтин', 10]],
    ['main'], { universality: 3 }),

  // ── Риба ─────────────────────────────────────────────────────────────
  dish('meal_baked_fish', 'Риба на фурна с картофи', [['риба', 150], ['картофи', 200], ['Зеленчуци', 80], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_grilled_fish_veg', 'Риба на скара със зеленчуци', [['риба', 150], ['броколи', 150], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_fish_rice', 'Риба с ориз', [['риба', 150], ['ориз', 150], ['Зеленчуци', 80], ['зехтин', 10]],
    ['main'], { universality: 5 }),
  dish('meal_salmon_potato', 'Сьомга с картофи', [['сьомга', 130], ['картофи', 200], ['спанак', 80], ['зехтин', 8]],
    ['main']),
  dish('meal_salmon_salad', 'Сьомга със салата', [['сьомга', 130], ['маруля', 80], ['пълнозърнест хляб', 60], ['зехтин', 10]],
    ['main']),
  dish('meal_tuna_salad', 'Салата с риба тон', [['риба тон', 120], ['маруля', 100], ['зехтин', 10]],
    ['main', 'snack'], { universality: 5 }),
  dish('meal_mackerel_potato', 'Скумрия с картофи', [['скумрия', 120], ['картофи', 200], ['спанак', 80], ['зехтин', 8]],
    ['main'], { universality: 3 }),
  dish('meal_shrimp_pasta', 'Паста със скариди и домати', [['паста', 150], ['скариди', 120], ['Домати', 80], ['зехтин', 10]],
    ['main'], { universality: 3 }),
  ...
  dish('meal_green_salad', 'Зелена салата', [['Зеленчуци', 150], ['Краставици', 80], ['зехтин', 10]],
    ['main'], { vegan: true, universality: 5 }),
  dish('meal_egg_potato', 'Яйца с картофи и чушки', [['яйца', 120], ['картофи', 180], ['Чушки', 60], ['зехтин', 10]],
    ['breakfast', 'main'], { vegetarian: true }),
  dish('meal_cottage_veg', 'Извара със зеленчуци', [['извара', 150], ['Краставици', 80], ['Домати', 80]],
    ['main', 'snack'], { vegetarian: true }),
  dish('meal_tofu_rice', 'Тофу с ориз и броколи', [['тофу', 150], ['ориз', 150], ['броколи', 80], ['зехтин', 10]],
