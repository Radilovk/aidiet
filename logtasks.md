...
## 2026-05-30 — Gaming questions: връщане към chat-bubble визията

**Задача:** Гейминг въпросите да изглеждат както преди във фронтенда — чат иконата да се вдига анимирано, въпросът да излиза в bubble контейнер до нея, а след отговор иконата да се връща надолу, с минимум нов код.

**Потвърдена причина:**
- Старият bubble + raised chat FAB flow още съществува в `plan.html`, но `quick-answer.html` е бил заменен с отделна центрирана full-screen card визия.
- Точно `quick-answer.html` се отваря от геймификационните quick-answer пътища и затова визуално вече не съвпада със стария frontend модел, който потребителят иска.

**Направено:**
- `quick-answer.html`: върната е bubble-style обвивка с AI header и чат FAB, позиционирани по модела на стария frontend flow.
- `quick-answer.html`: добавено е анимирано вдигане на чат иконата преди показване на въпроса.
- `quick-answer.html`: след render на записан/успешен отговор чат иконата се сваля обратно надолу, без да се пипа съществуващият save flow.
