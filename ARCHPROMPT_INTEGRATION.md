...
Успешно интегрирахме логиката от `archprompt.txt` в AI системата за генериране на хранителни планове. Системата вече използва sophisticirана диетична логика, която работи като "логически конструктор" на хранене.
