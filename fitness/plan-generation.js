...
export function buildAdminPlanUserPrompt(brief, layers, foundation = '') {
  ...
  individualBlock.push(
    '',
    'РЕЖИМ: Треньорът описва клиента и програмата на свободен текст. Интерпретирай всичко — пол, възраст, цел, оборудване, забрани, дни и упражнения. Прецизирай, изглади и структурирай в седмичен план без да пропускаш детайл.',
